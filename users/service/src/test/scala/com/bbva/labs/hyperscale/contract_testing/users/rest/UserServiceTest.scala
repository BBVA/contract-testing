 ...
 * #L%
 */
package com.bbva.labs.hyperscale.contract_testing.users.rest
...
class UserServiceTest extends FunSpec with Matchers with ScalatestRouteTest with MockFactory {

    describe("When requesting Get Users") {
        it("should return 200") {
            Get("/api/users") ~> UserService.route ~> check {
