 ...
 * #L%
 */
package com.bbva.labs.hyperscale.contract_testing.sales.app
...
import com.bbva.labs.hyperscale.contract_testing.sales.rest.SalesService
...
class WebServer(port: Int) {
    def start(): Future[Unit] = {
        serverBinding = Http().bindAndHandle(SalesService.route, "0.0.0.0", port)
    ...
    private implicit val system = ActorSystem("sales")
